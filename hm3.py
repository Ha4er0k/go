...
patterns = {
    "text1_true": "жадібний алгоритм",
    "text1_false": "фрактальна компресія",
    "text2_true": "розгорнутий список",
    "text2_false": "машинне навчання"
}
...
for label, pattern in patterns.items():
    text = text1 if "text1" in label else text2
    for name, func in [("Boyer-Moore", boyer_moore),
                       ("KMP", kmp_search),
                       ("Rabin-Karp", rabin_karp)]:
        duration = benchmark(func, text, pattern)
        results.append({
            "Algorithm": name,
            "Text": label,
            "Pattern": pattern,
